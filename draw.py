    ...
    _template = Template(
        ...
        {% macro script(this, kwargs) %}
            ...
            document.getElementById('export').onclick = function(e) {
                ...
                parent.document.getElementById("modal-save-polygon").style.display = "flex";
                parent.document.getElementById("coordinates").value = JSON.stringify(data['features'][0]['geometry']['coordinates']);
                parent.postMessage("meuElemento", "http://localhost:5000");
            }
            {% endif %}
        {% endmacro %}
        """
